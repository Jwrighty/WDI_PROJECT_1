...
kungfu.selectTop = function selectTop() {
  ...
  this.$character.css('background', 'url(/Users/Jason/Development/WDI_PROJECT_1/images/karate_char_high.png) no-repeat');
};

kungfu.selectMidRight = function selectMidRight() {
  this.$character.children().removeClass();
  this.$midDiv.attr('class', 'selected');
  this.$character.css('background', 'url(/Users/Jason/Development/WDI_PROJECT_1/images/karate_char_mid.png) no-repeat');
};

kungfu.selectMidLeft = function selectMidLeft() {
  this.$character.children().removeClass();
  this.$midDiv.attr('class', 'selected');
  this.$character.css('background', 'url(/Users/Jason/Development/WDI_PROJECT_1/images/karate_char_left.png) no-repeat');
};

kungfu.selectBottom = function selectBottom() {
  this.$character.children().removeClass();
  this.$botDiv.attr('class', 'selected');
  this.$character.css('background', 'url(/Users/Jason/Development/WDI_PROJECT_1/images/karate_char_low.png) no-repeat');
};

kungfu.returnStance = function returnStance() {
  this.$character.css('background', 'url(/Users/Jason/Development/WDI_PROJECT_1/images/karate_char_stand.png) no-repeat');
  this.$character.children().removeClass();
};
...
kungfu.gameOver = function gameOver() {
  ...
  this.$character.css('background', 'url(/Users/Jason/Development/WDI_PROJECT_1/images/karate_char_dead.png)');
